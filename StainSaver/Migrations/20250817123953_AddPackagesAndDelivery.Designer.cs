...
namespace StainSaver.Migrations
{
    ...
    [Migration("20250817123953_AddPackagesAndDelivery")]
    partial class AddPackagesAndDelivery
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StainSaver.Models.DeliveryItem", b =>
                {
                    b.HasOne("StainSaver.Models.Delivery", "Delivery")
                        .WithMany()
            ...
            modelBuilder.Entity("StainSaver.Models.Package", b =>
                {
                    ...
                    b.HasOne("StainSaver.Models.Delivery", "Delivery")
                        .WithOne("Package")
                        .HasForeignKey("StainSaver.Models.Package", "DeliveryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
