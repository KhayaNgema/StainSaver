...
namespace StainSaver.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingDetails_LaundryServices_LaundryServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingId = table.Column<int>(type: "int", nullable: false),
                    DetergentType = table.Column<int>(type: "int", nullable: false),
                    LaundryBagRequired = table.Column<bool>(type: "bit", nullable: false),
                    TShirtsCount = table.Column<int>(type: "int", nullable: false),
                    DressesCount = table.Column<int>(type: "int", nullable: false),
                    TrousersCount = table.Column<int>(type: "int", nullable: false),
                    BlanketsCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingPreferences_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingDetails_LaundryServiceId",
                table: "BookingDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingPreferences_BookingId",
