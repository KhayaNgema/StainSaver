...
ALTER TABLE [AspNetUsers] ADD [AlternativeContactNumber] nvarchar(max) NULL;
GO
...
ALTER TABLE [AspNetUsers] ADD [IdNumber] nvarchar(max) NULL;
GO
...
ALTER TABLE [AspNetUsers] ADD [Suburb] nvarchar(max) NULL;
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250325201457_AddCustomUserAndRoles', N'8.0.12');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250325212525_AddLaundryServices', N'8.0.12');
GO
